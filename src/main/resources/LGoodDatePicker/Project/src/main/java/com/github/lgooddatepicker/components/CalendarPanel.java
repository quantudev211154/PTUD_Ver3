...
public class CalendarPanel extends JPanel {
    ...
    private CalendarPanel(DatePickerSettings datePickerSettings,
        ...
        //Tu viet lai cho nay thoi nha
        customLaiCacNutDieuHuongThoiGianByTuHehe();
    ...
    private void customLaiCacNutDieuHuongThoiGianByTuHehe() {
        buttonPreviousYear.setText("");
        buttonPreviousYear.setIcon(new ImageIcon(
                Toolkit.getDefaultToolkit().getImage("src/main/resources/BieuTuong/LeftChevron_16px_2.png")
        ));

        buttonPreviousMonth.setText("");
        buttonPreviousMonth.setIcon(new ImageIcon(
                Toolkit.getDefaultToolkit().getImage("src/main/resources/BieuTuong/LeftChevron_16px_1.png")
        ));

        buttonNextYear.setText("");
        buttonNextYear.setIcon(new ImageIcon(
                Toolkit.getDefaultToolkit().getImage("src/main/resources/BieuTuong/RightChevron_16px_2.png")
        ));

        buttonNextMonth.setText("");
        buttonNextMonth.setIcon(new ImageIcon(
                Toolkit.getDefaultToolkit().getImage("src/main/resources/BieuTuong/RightChevron_16px_1.png")
        ));
    }
